 ...
 *
 * @see https://meatwiki.nii.ac.jp/confluence/display/GakuNinShibInstall/Embedded+DS
 */
...
var wayf_border_color = '<?php echo $wayfBorderColor ?>';
...
// ###################################
// # for test-ds only
// # @see https://test-ds.gakunin.nii.ac.jp/WAYF/embedded-wayf.js/snippet.html
// ###################################
...
<script type="text/javascript" charset="UTF-8"><!--
	document.write('<script type="text/javascript" src="' + wayf_URL + '/embedded-wayf.js?' + (new Date().getTime()) + '"></scr'+'ipt>');
	//-->
</script>
